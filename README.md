...
This is just an UI  written in C# with [AvaloniaUI](https://github.com/AvaloniaUI/Avalonia), [YoutubeExplode](https://github.com/Tyrrrz/YoutubeExplode) libraries and [ffmpeg](https://www.ffmpeg.org/) as dependency.
